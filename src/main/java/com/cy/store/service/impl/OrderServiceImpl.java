...
public class OrderServiceImpl implements IOrderService {
    ...
    public List<Order> findByUid(Integer uid) {
        List<Order> result = orderMapper.selectByUid(uid);
        return result;
    }

    @Override
    public Integer updateStatus(Integer oid) {
        Integer result = orderMapper.updateStatus(oid,new Date());
        return result;
    }

    @Override
    public List<OrderItem> findOrderItemByOid(Integer oid) {
        List<OrderItem> result = orderMapper.selectOrderItemByOid(oid);
        return result;
    }

    @Override
    public Order findOrderByOid(Integer oid) {
        Order result = orderMapper.selectOrderByOid(oid);
        return result;
    }
}